...
fun NumberScreen(
    ...
    Text(text = "Phone number will be used for the purpose of all communication.You shall receive an One Time Password(OTP) over there",
    fontSize = 12.sp,
    ...
    TextField(
        ...
        label = {
            Text(text = "Add Phone Number here")
        },
        modifier = Modifier.fillMaxWidth(),
        singleLine = true
    )
